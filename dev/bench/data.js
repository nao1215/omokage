    ...
    "Benchmark": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "90cb750bfe942aaa42ee4598282ab4520c648406",
          "message": "docs: refresh scoring docs and examples",
          "timestamp": "2026-06-12T10:45:59+09:00",
          "tree_id": "229ccf098d5cccaa68e0b43bcba013ad7fc95090",
          "url": "https://github.com/nao1215/omokage/commit/90cb750bfe942aaa42ee4598282ab4520c648406"
        },
        "date": 1781228800086,
        "tool": "go",
        "benches": [
          {
            "name": "BenchmarkExtractText (github.com/nao1215/omokage/internal/feature)",
            "value": 6672174,
            "unit": "ns/op\t 2831028 B/op\t   45410 allocs/op",
            "extra": "151 times\n4 procs"
          },
          {
            "name": "BenchmarkExtractText (github.com/nao1215/omokage/internal/feature) - ns/op",
          ...
          },
          {
            "name": "BenchmarkExplain (github.com/nao1215/omokage/internal/profile)",
            "value": 338763,
            "unit": "ns/op\t  215161 B/op\t     905 allocs/op",
            "extra": "3910 times\n4 procs"
          },
          {
            "name": "BenchmarkExplain (github.com/nao1215/omokage/internal/profile) - ns/op",
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "9555ee7e007c7ca4f303a0097fdbb926c9271eec",
          "message": "docs: cut the 0.5.0 release in the changelog",
          "timestamp": "2026-06-12T10:51:59+09:00",
          "tree_id": "69df4d3f1df5ed24bd2d0e22295bbe479c34b20f",
          "url": "https://github.com/nao1215/omokage/commit/9555ee7e007c7ca4f303a0097fdbb926c9271eec"
        },
        "date": 1781229156331,
        "tool": "go",
        "benches": [
          {
            "name": "BenchmarkExtractText (github.com/nao1215/omokage/internal/feature)",
            "value": 3728609,
            "unit": "ns/op\t 1908588 B/op\t   27533 allocs/op",
            "extra": "274 times\n4 procs"
          },
          {
            "name": "BenchmarkExtractText (github.com/nao1215/omokage/internal/feature) - ns/op",
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "f0f42bf19ed604dec2806933e9f054d9a27bd00a",
          "message": "test(cmd): address review feedback on the Debimate regression tests\n\n- Fix \"behaviour\" -> \"behavior\" (misspell).\n- Mark the four Debimate regression tests t.Parallel(); each trains into its own\n  temp workDir, so they are independent.\n- Check filepath.Abs via the existing fixtureAbs helper instead of ignoring the\n  error.\n\nAlso tighten the dotted/hyphenated identifier rule (CodeRabbit): a token whose\nsegments are all single letters is a prose abbreviation (e.g, i.e, a.k.a), not an\nidentifier like sql.DB, so it is no longer masked.",
          "timestamp": "2026-06-21T12:02:32+09:00",
          "tree_id": "70f1e0d966775c549b17f3cb634f91bda84c5f96",
          "url": "https://github.com/nao1215/omokage/commit/f0f42bf19ed604dec2806933e9f054d9a27bd00a"
        },
        "date": 1782010993784,
        "tool": "go",
        "benches": [
          {
            "name": "BenchmarkExtractText (github.com/nao1215/omokage/internal/feature)",
            "value": 2238237,
            "unit": "ns/op\t  791693 B/op\t    5687 allocs/op",
            "extra": "566 times\n4 procs"
          },
          {
            "name": "BenchmarkExtractText (github.com/nao1215/omokage/internal/feature) - ns/op",
          ...
          },
          {
            "name": "BenchmarkScore (github.com/nao1215/omokage/internal/profile)",
            "value": 221278,
            "unit": "ns/op\t   95352 B/op\t     746 allocs/op",
            "extra": "5992 times\n4 procs"
          },
          {
            "name": "BenchmarkScore (github.com/nao1215/omokage/internal/profile) - ns/op",
          ...
          },
          {
            "name": "BenchmarkCompare (github.com/nao1215/omokage/internal/profile)",
            "value": 226988,
            "unit": "ns/op\t   82641 B/op\t     744 allocs/op",
            "extra": "5691 times\n4 procs"
          },
          {
            "name": "BenchmarkCompare (github.com/nao1215/omokage/internal/profile) - ns/op",
          ...
          },
          {
            "name": "BenchmarkExplain (github.com/nao1215/omokage/internal/profile)",
            "value": 298699,
            "unit": "ns/op\t  224554 B/op\t     803 allocs/op",
            "extra": "5058 times\n4 procs"
          },
          {
            "name": "BenchmarkExplain (github.com/nao1215/omokage/internal/profile) - ns/op",
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "da8dd05645f79c9cf1b34136824353dc274cb6fc",
          "message": "feat(explain): add segment_style_drift, a median per-paragraph drift aggregate\n\nSurfaces the v2 paragraph-level aggregate deferred from the topic-masking work:\nthe median, across a document's prose paragraphs, of each paragraph's localizable\ndrift (register, script balance, sentence-shape z against the author). It is a\nrobust, document-level companion to the existing worst-paragraph list — \"how far\ndoes a typical paragraph stray\" rather than only the single worst one.\n\n- Reported in both `check --explain` (a \"Typical paragraph drift (median)\" line)\n  and `check --format json` (an additive `segment_style_drift` field).\n- Informational only: it never feeds the similarity score. A test asserts the\n  score is identical with and without segments supplied.\n- Reuses the same localizable feature subset and minimum paragraph length as the\n  worst-paragraph localization, so the two agree on which paragraphs count.\n\nAdds unit tests (ranking + score-independence) and extends the check JSON test.\nUpdates README and CHANGELOG.",
          "timestamp": "2026-06-21T12:18:05+09:00",
          "tree_id": "84c6a8d2effe29ac0fcd003df31e7ca3921fcfdd",
          "url": "https://github.com/nao1215/omokage/commit/da8dd05645f79c9cf1b34136824353dc274cb6fc"
        },
        "date": 1782011928898,
        "tool": "go",
        "benches": [
          {
            "name": "BenchmarkExtractText (github.com/nao1215/omokage/internal/feature)",
            "value": 2256738,
            "unit": "ns/op\t  791929 B/op\t    5681 allocs/op",
            "extra": "634 times\n4 procs"
          },
          {
            "name": "BenchmarkExtractText (github.com/nao1215/omokage/internal/feature) - ns/op",
          ...
          },
          {
            "name": "BenchmarkScore (github.com/nao1215/omokage/internal/profile)",
            "value": 229452,
            "unit": "ns/op\t   95354 B/op\t     746 allocs/op",
            "extra": "5126 times\n4 procs"
          },
          {
            "name": "BenchmarkScore (github.com/nao1215/omokage/internal/profile) - ns/op",
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "97feb40bc4c8b45738c938de3ccf12fdc488bf38",
          "message": "Merge pull request #16 from nao1215/test/atago-e2e-combined-coverage\n\ntest(e2e): add atago black-box E2E suite with combined unit+E2E coverage",
          "timestamp": "2026-07-07T20:46:19+09:00",
          "tree_id": "f983728ab3b34a6a8ff656a7de388b87c7f9d98b",
          "url": "https://github.com/nao1215/omokage/commit/97feb40bc4c8b45738c938de3ccf12fdc488bf38"
        },
        "date": 1783424832716,
        "tool": "go",
        "benches": [
          {
            "name": "BenchmarkExtractText (github.com/nao1215/omokage/internal/feature)",
            "value": 2446777,
            "unit": "ns/op\t  793423 B/op\t    5669 allocs/op",
            "extra": "412 times\n4 procs"
          },
          {
            "name": "BenchmarkExtractText (github.com/nao1215/omokage/internal/feature) - ns/op",
          ...
          },
          {
            "name": "BenchmarkExplain (github.com/nao1215/omokage/internal/profile)",
            "value": 307610,
            "unit": "ns/op\t  238971 B/op\t     812 allocs/op",
            "extra": "4830 times\n4 procs"
          },
          {
            "name": "BenchmarkExplain (github.com/nao1215/omokage/internal/profile) - ns/op",
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "662b452234d33b9a795b15b142769b371ee403b7",
          "message": "Merge pull request #17 from nao1215/fix/reject-url-in-check-and-diff\n\nfix(cli): reject URL arguments in check and diff by name",
          "timestamp": "2026-07-07T21:03:14+09:00",
          "tree_id": "ed0663547c5a31b09a27b91fdcab22e38fd7911a",
          "url": "https://github.com/nao1215/omokage/commit/662b452234d33b9a795b15b142769b371ee403b7"
        },
        "date": 1783425837906,
        "tool": "go",
        "benches": [
          {
            "name": "BenchmarkExtractText (github.com/nao1215/omokage/internal/feature)",
            "value": 2139471,
            "unit": "ns/op\t  786725 B/op\t    5660 allocs/op",
            "extra": "668 times\n4 procs"
          },
          {
            "name": "BenchmarkExtractText (github.com/nao1215/omokage/internal/feature) - ns/op",
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "92f14c4420f5c5dd564ccb125cec26eff4bff917",
          "message": "Merge pull request #18 from nao1215/release/v0.6.0\n\ndocs: cut the 0.6.0 release and switch the coverage badge to octocov",
          "timestamp": "2026-07-07T21:14:24+09:00",
          "tree_id": "71a6d2290a72380a2276d1a55f67c9f7cbec5370",
          "url": "https://github.com/nao1215/omokage/commit/92f14c4420f5c5dd564ccb125cec26eff4bff917"
        },
        "date": 1783426510241,
        "tool": "go",
        "benches": [
          {
            "name": "BenchmarkExtractText (github.com/nao1215/omokage/internal/feature)",
            "value": 2497548,
            "unit": "ns/op\t  796495 B/op\t    5695 allocs/op",
            "extra": "565 times\n4 procs"
          },
          {
            "name": "BenchmarkExtractText (github.com/nao1215/omokage/internal/feature) - ns/op",
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "5eefd34387b7f668e15e9d246bfb937ab5a3179b",
          "message": "docs(readme): update repository badges (#20)",
          "timestamp": "2026-07-20T22:19:50+09:00",
          "tree_id": "d23e39549d23325b1a2b8ad564ebf312432054d9",
          "url": "https://github.com/nao1215/omokage/commit/5eefd34387b7f668e15e9d246bfb937ab5a3179b"
        },
        "date": 1784553674882,
        "tool": "go",
        "benches": [
          {
            "name": "BenchmarkExtractText (github.com/nao1215/omokage/internal/feature)",
            "value": 2249439,
            "unit": "ns/op\t  794488 B/op\t    5693 allocs/op",
            "extra": "648 times\n4 procs"
          },
          {
            "name": "BenchmarkExtractText (github.com/nao1215/omokage/internal/feature) - ns/op",
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "bf2449b49ca604606168622beb1ab097035d0916",
          "message": "ci: bump atago to v0.13.0 (#21)",
          "timestamp": "2026-07-26T21:50:53+09:00",
          "tree_id": "2318ad130b6e0be651cccf4ddc941e9e906c5673",
          "url": "https://github.com/nao1215/omokage/commit/bf2449b49ca604606168622beb1ab097035d0916"
        },
        "date": 1785070280506,
        "tool": "go",
        "benches": [
          {
            "name": "BenchmarkExtractText (github.com/nao1215/omokage/internal/feature)",
            "value": 1781340,
            "unit": "ns/op\t  786599 B/op\t    5660 allocs/op",
            "extra": "667 times\n4 procs"
          },
          {
            "name": "BenchmarkExtractText (github.com/nao1215/omokage/internal/feature) - ns/op",
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "0774e254d68f3f34cedda44527510a2fef119c6d",
          "message": "chore(ci): bump atago to v0.16.0 (#23)",
          "timestamp": "2026-07-27T20:35:00+09:00",
          "tree_id": "1652066aaa02b4e52a927e2bb99d3ed162d6f168",
          "url": "https://github.com/nao1215/omokage/commit/0774e254d68f3f34cedda44527510a2fef119c6d"
        },
        "date": 1785152127691,
        "tool": "go",
        "benches": [
          {
            "name": "BenchmarkExtractText (github.com/nao1215/omokage/internal/feature)",
            "value": 1784442,
            "unit": "ns/op\t  789359 B/op\t    5673 allocs/op",
            "extra": "648 times\n4 procs"
          },
          {
            "name": "BenchmarkExtractText (github.com/nao1215/omokage/internal/feature) - ns/op",
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "a3297282eb60f8cac6789e775c60088bb479c1b2",
          "message": "Merge pull request #24 from nao1215/chore/bump-atago-v0.17.0\n\nchore(ci): bump atago to v0.17.0",
          "timestamp": "2026-08-04T23:20:28+09:00",
          "tree_id": "adc380dc042e5c024c72ef30182a325ae5b161fe",
          "url": "https://github.com/nao1215/omokage/commit/a3297282eb60f8cac6789e775c60088bb479c1b2"
        },
        "date": 1785853282901,
        "tool": "go",
        "benches": [
          {
            "name": "BenchmarkExtractText (github.com/nao1215/omokage/internal/feature)",
            "value": 2174044,
            "unit": "ns/op\t  795618 B/op\t    5679 allocs/op",
            "extra": "496 times\n4 procs"
          },
          {
            "name": "BenchmarkExtractText (github.com/nao1215/omokage/internal/feature) - ns/op",
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "317a11763146d1c46384a1146a84612e8150616e",
          "message": "chore(ci): bump atago to v0.20.0 (#25)\n\nAlso adds the tested-with-atago badge, so the README says what the E2E suite is driven by.",
          "timestamp": "2026-08-15T22:20:28+09:00",
          "tree_id": "f52cfeb837427e5cc4745c91982892821772ec82",
          "url": "https://github.com/nao1215/omokage/commit/317a11763146d1c46384a1146a84612e8150616e"
        },
        "date": 1786800098983,
        "tool": "go",
        "benches": [
          {
            "name": "BenchmarkExtractText (github.com/nao1215/omokage/internal/feature)",
            "value": 2172444,
            "unit": "ns/op\t  786622 B/op\t    5660 allocs/op",
            "extra": "532 times\n4 procs"
          },
          {
            "name": "BenchmarkExtractText (github.com/nao1215/omokage/internal/feature) - ns/op",
          ...
          },
          {
            "name": "BenchmarkExplain (github.com/nao1215/omokage/internal/profile)",
            "value": 305421,
            "unit": "ns/op\t  238969 B/op\t     812 allocs/op",
            "extra": "4992 times\n4 procs"
          },
          {
            "name": "BenchmarkExplain (github.com/nao1215/omokage/internal/profile) - ns/op",
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "d6f14107d3e382a9a4f3ce0701472fbe57095cc7",
          "message": "docs(readme): document the omokage-bin AUR package (#26)\n\nA community-maintained omokage-bin package tracking the release binaries exists on the AUR, but the README did not mention it.",
          "timestamp": "2026-08-27T22:58:43+09:00",
          "tree_id": "b8c868f8fac29b00bdc20da372f8abae27c535da",
          "url": "https://github.com/nao1215/omokage/commit/d6f14107d3e382a9a4f3ce0701472fbe57095cc7"
        },
        "date": 1787839171309,
        "tool": "go",
        "benches": [
          {
            "name": "BenchmarkExtractText (github.com/nao1215/omokage/internal/feature)",
            "value": 1642211,
            "unit": "ns/op\t  791078 B/op\t    5675 allocs/op",
            "extra": "722 times\n4 procs"
          },
          {
            "name": "BenchmarkExtractText (github.com/nao1215/omokage/internal/feature) - ns/op",
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "e8597d9b4ed02bf94663f1e2a3651f56748adab7",
          "message": "chore: bump dependencies, atago v0.21.0, and track the newest Go in CI (#27)",
          "timestamp": "2026-08-30T05:41:19+09:00",
          "tree_id": "b43781717c56295e62a761817df528d3746d7f34",
          "url": "https://github.com/nao1215/omokage/commit/e8597d9b4ed02bf94663f1e2a3651f56748adab7"
        },
        "date": 1788036130743,
        "tool": "go",
        "benches": [
          {
            "name": "BenchmarkExtractText (github.com/nao1215/omokage/internal/feature)",
            "value": 2198243,
            "unit": "ns/op\t  788555 B/op\t    5663 allocs/op",
            "extra": "609 times\n4 procs"
          },
          {
            "name": "BenchmarkExtractText (github.com/nao1215/omokage/internal/feature) - ns/op",
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "41696772c6adf67e740304571f99077c2a870ba6",
          "message": "docs(readme): credit the external maintainer who packages omokage (#28)",
          "timestamp": "2026-08-30T11:28:09+09:00",
          "tree_id": "688a3fd1c6cb29fa7c3c607e7f77ae2ff30d0781",
          "url": "https://github.com/nao1215/omokage/commit/41696772c6adf67e740304571f99077c2a870ba6"
        },
        "date": 1788056916697,
        "tool": "go",
        "benches": [
          {
            "name": "BenchmarkExtractText (github.com/nao1215/omokage/internal/feature)",
            "value": 1372944,
            "unit": "ns/op\t  784672 B/op\t    5644 allocs/op",
            "extra": "841 times\n4 procs"
          },
          {
            "name": "BenchmarkExtractText (github.com/nao1215/omokage/internal/feature) - ns/op",
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "0788539c17425232af6edb8f713e8d3d6ebf49b8",
          "message": "chore: bump deps, atago v0.22.0, and make golangci-lint a gate (#29)\n\n* build(deps): bump sqlite and libc, run E2E with atago v0.22.0\n\n* ci(lint): make golangci-lint a gate and clear what it had been reporting",
          "timestamp": "2026-09-12T22:15:25+09:00",
          "tree_id": "9a68844978d2ca65d73cc9eb2d108263bec3cf9b",
          "url": "https://github.com/nao1215/omokage/commit/0788539c17425232af6edb8f713e8d3d6ebf49b8"
        },
        "date": 1789218979566,
        "tool": "go",
        "benches": [
          {
            "name": "BenchmarkExtractText (github.com/nao1215/omokage/internal/feature)",
            "value": 2451448,
            "unit": "ns/op\t  793843 B/op\t    5664 allocs/op",
            "extra": "474 times\n4 procs"
          },
          {
            "name": "BenchmarkExtractText (github.com/nao1215/omokage/internal/feature) - ns/op",
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "6ef034632aa192688c87613693b35fd175c2ff4f",
          "message": "fix(cli): say what was wrong instead of printing usage or a syscall error (#30)",
          "timestamp": "2026-09-12T22:22:20+09:00",
          "tree_id": "9c5946ad17f9a206fa9e86fb1319ca2a85ed23d0",
          "url": "https://github.com/nao1215/omokage/commit/6ef034632aa192688c87613693b35fd175c2ff4f"
        },
        "date": 1789219384257,
        "tool": "go",
        "benches": [
          {
            "name": "BenchmarkExtractText (github.com/nao1215/omokage/internal/feature)",
            "value": 1980136,
            "unit": "ns/op\t  790770 B/op\t    5671 allocs/op",
            "extra": "583 times\n4 procs"
          },
          {
            "name": "BenchmarkExtractText (github.com/nao1215/omokage/internal/feature) - ns/op",
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "28f2b97045defa8ff140d8397abdc268075db829",
          "message": "chore(release): prepare v0.6.1 (#31)",
          "timestamp": "2026-09-12T22:33:30+09:00",
          "tree_id": "f42146d5c89b1817ff0a62a71bc56e0c3e5dbb52",
          "url": "https://github.com/nao1215/omokage/commit/28f2b97045defa8ff140d8397abdc268075db829"
        },
        "date": 1789220053461,
        "tool": "go",
        "benches": [
          {
            "name": "BenchmarkExtractText (github.com/nao1215/omokage/internal/feature)",
            "value": 2218759,
            "unit": "ns/op\t  794655 B/op\t    5679 allocs/op",
            "extra": "584 times\n4 procs"
          },
          {
            "name": "BenchmarkExtractText (github.com/nao1215/omokage/internal/feature) - ns/op",
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "31fecb5f8e09e192120bacd34c486894b8de1eef",
          "message": "test(demo): guard the VHS tapes against a renamed command (#32)",
          "timestamp": "2026-09-12T23:54:38+09:00",
          "tree_id": "6ec1d3d3c01264b1449a8cff17183419de509adc",
          "url": "https://github.com/nao1215/omokage/commit/31fecb5f8e09e192120bacd34c486894b8de1eef"
        },
        "date": 1789224930163,
        "tool": "go",
        "benches": [
          {
            "name": "BenchmarkExtractText (github.com/nao1215/omokage/internal/feature)",
            "value": 2238462,
            "unit": "ns/op\t  790441 B/op\t    5681 allocs/op",
            "extra": "471 times\n4 procs"
          },
          {
            "name": "BenchmarkExtractText (github.com/nao1215/omokage/internal/feature) - ns/op",
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "16fdbdada85855787b8a1f0f1d61b621e7109c94",
          "message": "test(e2e): run the atago suite on Windows (#33)",
          "timestamp": "2026-09-12T23:57:20+09:00",
          "tree_id": "9dc512ef02fe3d000d0c0250b5fe8e9c768424f5",
          "url": "https://github.com/nao1215/omokage/commit/16fdbdada85855787b8a1f0f1d61b621e7109c94"
        },
        "date": 1789225084452,
        "tool": "go",
        "benches": [
          {
            "name": "BenchmarkExtractText (github.com/nao1215/omokage/internal/feature)",
            "value": 2260284,
            "unit": "ns/op\t  794819 B/op\t    5691 allocs/op",
            "extra": "468 times\n4 procs"
          },
          {
            "name": "BenchmarkExtractText (github.com/nao1215/omokage/internal/feature) - ns/op",
